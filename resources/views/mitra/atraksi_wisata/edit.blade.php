        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <x-layout.button.back-button url="mitra/atraksi-wisata/{{$atraksi_wisata->id_kategori}}"/>

                    <h3 class="text-center">Edit Data Atraksi Wisata</h3>
                </div>
                <div class="card-body">

                    <form action="{{ url('mitra/atraksi-wisata', $atraksi_wisata->id) }}/update" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method("PUT")
